    ...
    <div class="w-[55%] flex flex-row justify-between ">
      <div class="flex justify-center items-center flex-col p-5">
        ...
        <form action="/" class="flex justify-evenly items-center flex-col my-4 h-[300px]">
          <input type="text" placeholder="نام" class="w-[330px] py-[13px] px-[13px] outline-none rounded-[20px] font-peyda border border-[#000000B2] bg-transparent placeholder:font-peyda placeholder:font-medium placeholder:text-black placeholder:opacity-80">
          ...
          <input type="password" placeholder="تکرار رمز" class="w-[330px] py-[13px] px-[13px] outline-none rounded-[20px] font-peyda border border-[#000000B2] bg-transparent placeholder:font-peyda placeholder:font-medium placeholder:text-black placeholder:opacity-80">
