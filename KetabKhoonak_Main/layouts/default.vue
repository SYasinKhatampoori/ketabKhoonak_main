...
<template>
  <div class="w-full flex flex-col justify-between items-center bg-[#FED8B1]">
    <header class="w-full h-[100px] bg-[#E4C09B] flex justify-center gap-x-[900px] items-center">
      ...
      <!--    menu-->
      <div class="relative flex flex-col items-center justify-center w-[68px] h-[68px]">
        <div @click="menuHandle"
          class="flex flex-col items-center justify-center w-[68px] h-[68px] bg-[#CBA985] rounded-full cursor-pointer transition-all"
          :class="showMenu ? 'rotate-90' : 'rotate-0'"
          >
          <img class="w-[42px] h-[42px]" src="../assets/icons/menu-svgrepo-com.svg" alt="">
        </div>
        <transition name="menu">
          <div v-if="showMenu" class="absolute w-[1113px] h-[511px] bg-[#FFEAD4] z-50 top-[124%] right-[10%] rounded-b-[20px] opacity-75">
      ...
      <div class="flex justify-evenly items-center w-[379px]">
        ...
        outline-none">ورود و ثیت نام</button>
        </nuxt-link>
      </div>
    </header>
    <main class="w-full">
    ...
    <footer class="w-full h-[318px] bg-[#987B5E] flex justify-evenly items-center ">
      ...
      <div class=" flex justify-center items-start flex-col w-auto p-5 h-[194px] border-l-4 border-[#00000080]">
        ...
        <h1 class="w-[382px] font-peyda font-medium text-white text-[20px] text-start">اواسط سال ۱۴۰۴، چند جوان پرانرژی
          ...
          که تازه شروع به فعالیت کرده‌اند،
          سایت‌هایی زیبا و کاربرپسند طراحی کنیم.</h1>
      </div>
      <!--    contact us-->
      <div
        class="font-peyda font-medium h-[194px] text-[20px] p-5 text-white flex justify-center items-start flex-col w-auto border-l-4 border-[#00000080]">
        <div class="flex flex-col items-center justify-center">
          <span>09121234567</span>
        </div>
        <div class="flex flex-col items-center justify-center">
          <span>قم|خیابان رسالت|کوچه 3|هنرستان نمونه دولتیگیوچی</span>
        </div>
        <div class="flex flex-col items-center justify-center">
      ...
      <!--    idon`t know-->
      <div
        class="flex flex-col items-center justify-evenly p-5 h-[194px] w-auto font-peyda font-medium text-white text-[18px]">
...
<!--
box-shadow: 0px 3px 0px 0px #00000040 inset;
